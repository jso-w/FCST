...
#TODO: improve performance... batching? async? run on GPU? EasyOCR instead of tesseract? 
...
class VideoProcessor:
    ...
    def run_scan(self, frame_skip, roi, progress_callback): #TODO: redo entire thing..........
        frame_i = 0
        ...
        while(self.vid.isOpened()):
            ...
            #TODO: more testing of the OCR... too many errors when footage has a bit of noise
            #blur could help with transparent windows (or just tell user not to use transp. windows...)
